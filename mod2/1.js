...
console.log(objarr.filter((obj) => obj["jd"].getFullYear() > d.getFullYear()));
console.log("-----filter by city------");
console.log(objarr.filter((obj) => obj["city"].toLowerCase() == "mumbai"));
function search(param) {
    console.log("----search y id---");
    console.log(objarr.filter(obj => obj["id"] == param));
}
function search_name(param) {
    console.log("----search y name---");
    console.log(objarr.filter(obj => obj["name"] == param));
}
search_name("emp15");
search(1);
console.log("=========filter by salary------------");
console.log(objarr.filter((obj) => obj["salary"] > 20000 && obj["salary"] < 50000));
